 ...
 *
 */
public class BluetoothSensor extends Service implements SensorConnector {
	private BluetoothAdapter bluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
	private BroadcastReceiver broadcastReceiver;
//	private Handler objHandler = new Handler();
	private com.ubiqlog.core.DataAcquisitor dataAcq;
	private static long BT_LOG_INTERVAL = 60000; // 60000= default values is 10 min
...
//	private TimerTask bluetoothTimerTask = new TimerTask() 
...
//		bluetoothTimer = new BTtimerTask();
//		readSensor();
//		objHandler.postDelayed(doBTLogging, BT_LOG_INTERVAL);
